...
def add_checks(cl: CheckList, env: TestEnv) -> None:
    ...
    cl.check(
        "spaces detected",
        "Spaces indentation is reported",
        "space" in r.lower(),
        f"got: {r!r}",
    )
    cl.check(
        "spaces verdict", "Verdict is 'spaces'", "spaces" in r.lower(), f"got: {r!r}"
    )
    ...
    cl.check(
        "tabs detected",
        "Tabs indentation is reported",
        "tab" in r.lower(),
        f"got: {r!r}",
    )
    cl.check("tabs verdict", "Verdict is 'tabs'", "tabs" in r.lower(), f"got: {r!r}")
    ...
    cl.check(
        "no indentation",
        "Reports no indentation for flat content",
        "no indentation" in r.lower(),
        f"got: {r!r}",
    )
