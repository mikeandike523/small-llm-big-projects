...
def add_checks(cl: CheckList, env: TestEnv) -> None:
    gn: dict = {}
    execute_tool(
        "todo_list", {"action": "add_item", "parent_path": "", "text": "root"}, gn
    )
    execute_tool(
        "todo_list", {"action": "add_item", "parent_path": "1", "text": "child"}, gn
    )
    execute_tool(
        "todo_list",
        {"action": "add_item", "parent_path": "1.1", "text": "grandchild"},
        gn,
    )
