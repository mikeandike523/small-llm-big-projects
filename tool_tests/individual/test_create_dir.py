...
def run(env: TestEnv, server: MicroServer | None = None):
    ...
    try:
        ...
        cl.check(
            ...
            "created" in r.lower() or new_dir in r,
            f"got: {r!r}",
        )
        cl.check(
            "simple dir exists",
        ...
        cl.check(
            "create nested dir result",
            "Result mentions success for nested creation",
            "created" in r2.lower() or nested_dir in r2,
            f"got: {r2!r}",
        )
        cl.check(
            "nested dir exists",
            "Nested directory actually exists on disk",
