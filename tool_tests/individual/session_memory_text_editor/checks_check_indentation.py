...
def add_checks(cl: CheckList, env: TestEnv) -> None:
    ...
    r_spaces = execute_tool("text_editor", {"action": "check_indentation", "key": "code"}, env.session_data)
    ...
    env.session_data["memory"]["code"] = "def foo():\n\tx = 1\n\treturn x\n"
    r_tabs = execute_tool("text_editor", {"action": "check_indentation", "key": "code"}, env.session_data)
