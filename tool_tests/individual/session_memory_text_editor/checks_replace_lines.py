...
def add_checks(cl: CheckList, env: TestEnv) -> None:
    ...
    r = execute_tool("text_editor", {"action": "replace_lines", "key": "key", "start_line": 2, "end_line": 2, "text": "B"}, env.session_data)
    ...
    env.session_data["memory"]["key"] = "a\nb\nc\n"
    r2 = execute_tool("text_editor", {"action": "replace_lines", "key": "key", "start_line": 1, "end_line": 2, "text": "X\nY"}, env.session_data)
    ...
    env.session_data["memory"]["key"] = "a\r\nb\r\nc\r\n"
    execute_tool("text_editor", {"action": "replace_lines", "key": "key", "start_line": 2, "end_line": 2, "text": "B"}, env.session_data)
    ...
    env.session_data["memory"]["key"] = "a\r\nb\r\nc\r\n"
    execute_tool("text_editor", {"action": "replace_lines", "key": "key", "start_line": 2, "end_line": 2, "text": "B", "disable_auto_eol": True}, env.session_data)
