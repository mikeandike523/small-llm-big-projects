...
def add_checks(cl: CheckList, env: TestEnv) -> None:
    ...
    r = execute_tool("text_editor", {"action": "insert_chars", "key": "buf", "start_char": 5, "text": ","}, env.session_data)
    ...
    execute_tool("text_editor", {"action": "insert_chars", "key": "buf", "start_char": 0, "text": "hello "}, env.session_data)
    ...
    execute_tool("text_editor", {"action": "insert_chars", "key": "buf", "start_char": 999, "text": " world"}, env.session_data)
    ...
    execute_tool("text_editor", {"action": "insert_chars", "key": "buf", "start_char": 6, "text": "extra\r\n"}, env.session_data)
