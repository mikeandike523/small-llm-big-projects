...
def add_checks(cl: CheckList, env: TestEnv) -> None:
    ...
    r = execute_tool("text_editor", {"action": "insert_lines", "key": "text", "before_line": 1, "text": "line0"}, env.session_data)
    ...
    env.session_data["memory"]["text"] = "line1\nline2\nline3\n"
    r2 = execute_tool("text_editor", {"action": "insert_lines", "key": "text", "before_line": 99, "text": "appended"}, env.session_data)
    ...
    env.session_data["memory"]["text"] = "line1\r\nline2\r\nline3\r\n"
    execute_tool("text_editor", {"action": "insert_lines", "key": "text", "before_line": 2, "text": "inserted"}, env.session_data)
    ...
    env.session_data["memory"]["text"] = "line1\r\nline2\r\n"
    execute_tool("text_editor", {"action": "insert_lines", "key": "text", "before_line": 2, "text": "lf_line\n", "disable_auto_eol": True}, env.session_data)
