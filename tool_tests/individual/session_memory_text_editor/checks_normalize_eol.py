...
def add_checks(cl: CheckList, env: TestEnv) -> None:
    ...
    r = execute_tool("text_editor", {"action": "normalize_eol", "key": "eol_key", "eol": "lf"}, env.session_data)
    ...
    env.session_data["memory"]["eol_key"] = "line1\nline2\n"
    r2 = execute_tool("text_editor", {"action": "normalize_eol", "key": "eol_key", "eol": "crlf"}, env.session_data)
