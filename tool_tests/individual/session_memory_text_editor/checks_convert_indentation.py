...
def add_checks(cl: CheckList, env: TestEnv) -> None:
    ...
    r = execute_tool("text_editor", {"action": "convert_indentation", "key": "code", "to": "tabs", "spaces_per_tab": 4}, env.session_data)
    ...
    env.session_data["memory"]["code"] = "def foo():\n\tx = 1\n"
    r2 = execute_tool("text_editor", {"action": "convert_indentation", "key": "code", "to": "spaces", "spaces_per_tab": 4}, env.session_data)
