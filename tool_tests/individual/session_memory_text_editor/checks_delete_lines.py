...
def add_checks(cl: CheckList, env: TestEnv) -> None:
    ...
    r = execute_tool("text_editor", {"action": "delete_lines", "key": "key", "start_line": 1, "end_line": 1}, env.session_data)
    ...
    r2 = execute_tool("text_editor", {"action": "delete_lines", "key": "key", "start_line": 2, "end_line": 3}, env.session_data)
    ...
    env.session_data["memory"]["key"] = "a\r\nb\r\nc\r\nd\r\n"
    execute_tool("text_editor", {"action": "delete_lines", "key": "key", "start_line": 2, "end_line": 2}, env.session_data)
