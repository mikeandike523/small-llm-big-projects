...
def add_checks(cl: CheckList, env: TestEnv) -> None:
    ...
    r = execute_tool("text_editor", {"action": "delete_chars", "key": "buf", "start_char": 5, "end_char": 7}, env.session_data)
    ...
    execute_tool("text_editor", {"action": "delete_chars", "key": "buf", "start_char": 0, "end_char": 2}, env.session_data)
    ...
    env.session_data["memory"]["buf"] = "abcde"
    execute_tool("text_editor", {"action": "delete_chars", "key": "buf", "start_char": 3, "end_char": 5}, env.session_data)
    ...
    env.session_data["memory"]["buf"] = "abc"
    execute_tool("text_editor", {"action": "delete_chars", "key": "buf", "start_char": 1, "end_char": 1}, env.session_data)
    ...
    env.session_data["memory"]["buf"] = "abc"
    r_err = execute_tool("text_editor", {"action": "delete_chars", "key": "buf", "start_char": 3, "end_char": 1}, env.session_data)
    ...
    execute_tool("text_editor", {"action": "delete_chars", "key": "buf", "start_char": 5, "end_char": 6}, env.session_data)
