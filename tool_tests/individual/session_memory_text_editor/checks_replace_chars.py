...
def add_checks(cl: CheckList, env: TestEnv) -> None:
    ...
    r = execute_tool("text_editor", {"action": "replace_chars", "key": "buf", "start_char": 6, "end_char": 11, "text": "there"}, env.session_data)
    ...
    execute_tool("text_editor", {"action": "replace_chars", "key": "buf", "start_char": 1, "end_char": 2, "text": ""}, env.session_data)
    ...
    env.session_data["memory"]["buf"] = "ab"
    execute_tool("text_editor", {"action": "replace_chars", "key": "buf", "start_char": 1, "end_char": 1, "text": "XY"}, env.session_data)
    ...
    execute_tool("text_editor", {"action": "replace_chars", "key": "buf", "start_char": 5, "end_char": 6, "text": "\r\n"}, env.session_data)
    ...
    r_err = execute_tool("text_editor", {"action": "replace_chars", "key": "buf", "start_char": 3, "end_char": 2, "text": "x"}, env.session_data)
