...
def add_checks(cl: CheckList, env: TestEnv) -> None:
    ...
    r = execute_tool("text_editor", {"action": "read_char_range", "key": "str"}, env.session_data)
    cl.check("read_char_range: full read", "Reading without start/end returns the entire value", r == "0123456789", f"got: {r!r}")

    r2 = execute_tool("text_editor", {"action": "read_char_range", "key": "str", "start_char": 2, "end_char": 5}, env.session_data)
